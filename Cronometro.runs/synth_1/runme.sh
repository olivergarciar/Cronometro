...
HD_PWD='C:/Users/Oliver/Documents/GitHub/Cronometro/Cronometro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contador_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contador_top.tcl
